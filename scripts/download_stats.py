...
repo_full = os.getenv("GITHUB_REPOSITORY", "AliceJump/ok-ap-x-anylabeling-asset")

if "/" in repo_full:
    OWNER, REPO = repo_full.split("/", 1)
else:
    OWNER = "AliceJump"
    REPO = "ok-ap-x-anylabeling-asset"
...
HEADERS = {
    ...
    "User-Agent": "ok-ap-x-anylabeling-asset-download-stats",
}
